 ...
 * default import.
 */
export function attachDefaultImportDeclaration(expr, importDecl) {
 ...
 * dependency.
 */
export function getDefaultImportDeclaration(expr) {
    var _a;
