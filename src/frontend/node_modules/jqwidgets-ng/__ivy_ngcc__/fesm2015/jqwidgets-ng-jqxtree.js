...
jqxTreeComponent.ɵfac = function jqxTreeComponent_Factory(t) { return new (t || jqxTreeComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
jqxTreeComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: jqxTreeComponent, selectors: [["jqxTree"]], inputs: { autoCreate: ["auto-create", "autoCreate"], attrAnimationShowDuration: ["animationShowDuration", "attrAnimationShowDuration"], attrAnimationHideDuration: ["animationHideDuration", "attrAnimationHideDuration"], attrAllowDrag: ["allowDrag", "attrAllowDrag"], attrAllowDrop: ["allowDrop", "attrAllowDrop"], attrCheckboxes: ["checkboxes", "attrCheckboxes"], attrDragStart: ["dragStart", "attrDragStart"], attrDragEnd: ["dragEnd", "attrDragEnd"], attrDisabled: ["disabled", "attrDisabled"], attrEasing: ["easing", "attrEasing"], attrEnableHover: ["enableHover", "attrEnableHover"], attrHasThreeStates: ["hasThreeStates", "attrHasThreeStates"], attrIncrementalSearch: ["incrementalSearch", "attrIncrementalSearch"], attrKeyboardNavigation: ["keyboardNavigation", "attrKeyboardNavigation"], attrRtl: ["rtl", "attrRtl"], attrSource: ["source", "attrSource"], attrToggleIndicatorSize: ["toggleIndicatorSize", "attrToggleIndicatorSize"], attrToggleMode: ["toggleMode", "attrToggleMode"], attrTheme: ["theme", "attrTheme"], attrWidth: ["width", "attrWidth"], attrHeight: ["height", "attrHeight"] }, outputs: { onAdded: "onAdded", onCheckChange: "onCheckChange", onCollapse: "onCollapse", onDragStart: "onDragStart", onDragEnd: "onDragEnd", onExpand: "onExpand", onItemClick: "onItemClick", onRemoved: "onRemoved", onSelect: "onSelect" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], ngContentSelectors: _c0, decls: 2, vars: 0, template: function jqxTreeComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵelementStart(0, "div");
        ɵngcc0.ɵɵprojection(1);
        ɵngcc0.ɵɵelementEnd();
    } }, encapsulation: 2 }); //jqxTreeComponent
...
jqxTreeComponent = __decorate([ __metadata("design:paramtypes", [ElementRef])
], jqxTreeComponent);

let jqxTreeModule = class jqxTreeModule {
};
jqxTreeModule.ɵfac = function jqxTreeModule_Factory(t) { return new (t || jqxTreeModule)(); };
jqxTreeModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: jqxTreeModule });
jqxTreeModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(jqxTreeComponent, [{
        type: Component,
        args: [{
                selector: 'jqxTree',
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(jqxTreeModule, [{
        type: NgModule,
        args: [{
                imports: [],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(jqxTreeModule, { declarations: [jqxTreeComponent], exports: [jqxTreeComponent] }); })();
