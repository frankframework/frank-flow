...
declare const isNotCommentToken: <T extends TSESTree.BlockComment | TSESTree.BooleanToken | TSESTree.LineComment | TSESTree.IdentifierToken | TSESTree.JSXIdentifierToken | TSESTree.JSXTextToken | TSESTree.KeywordToken | TSESTree.NullToken | TSESTree.NumericToken | TSESTree.PunctuatorToken | TSESTree.RegularExpressionToken | TSESTree.StringToken | TSESTree.TemplateToken>(token: T) => token is Exclude<T, TSESTree.Comment>;
