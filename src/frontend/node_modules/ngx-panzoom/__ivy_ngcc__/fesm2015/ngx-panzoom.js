...
PanZoomComponent.ɵfac = function PanZoomComponent_Factory(t) { return new (t || PanZoomComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
PanZoomComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: PanZoomComponent, selectors: [["pan-zoom"]], viewQuery: function PanZoomComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.frameElementRef = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.panElementRef = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.zoomElementRef = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.panzoomOverlayRef = _t.first);
    } }, inputs: { config: "config" }, ngContentSelectors: _c4, decls: 9, vars: 0, consts: [[1, "pan-zoom-frame"], ["frameElement", ""], [1, "pan-element"], ["panElement", ""], [1, "zoom-element"], ["zoomElement", ""], [1, "pan-zoom-overlay"], ["panzoomOverlay", ""]], template: function PanZoomComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PanZoomComponent, [{
        type: Component,
        args: [{
                selector: 'pan-zoom',
    ...
    }], function () { return [{ type: ɵngcc0.NgZone }]; }, { frameElementRef: [{
            type: ViewChild,
...
NgxPanZoomModule.ɵfac = function NgxPanZoomModule_Factory(t) { return new (t || NgxPanZoomModule)(); };
NgxPanZoomModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: NgxPanZoomModule });
NgxPanZoomModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [], imports: [[]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxPanZoomModule, [{
        type: NgModule,
        args: [{
                imports: [],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxPanZoomModule, { declarations: [PanZoomComponent], exports: [PanZoomComponent] }); })();
...
//# sourceMappingURL=ngx-panzoom.js.map