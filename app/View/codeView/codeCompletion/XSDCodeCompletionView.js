...
export default class XSDCodeCompletionView {
    ...
    notify(data) {
        ...
        const xsdCodeCompletionProvider = new XSDCodeCompletionProvider(ibisdoc)
        this.monaco.languages.registerCompletionItemProvider('xml', xsdCodeCompletionProvider.provider())
    }
